...
function registerStudioHandlers(
  ...
  // Lazy-init StudioService on first call
 ...
 * Maps `browser:*` channels to BrowserManager methods and forwards
 * status-changed events to the renderer window.
 */
