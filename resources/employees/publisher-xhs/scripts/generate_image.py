...
DEFAULT_OUTPUT_DIR = str(Path(__file__).parent.parent / "image")
...
def generate_image(
    prompt: str, output_dir: str = DEFAULT_OUTPUT_DIR, filename: str = None
) -> dict:
    """
    调用 DeerAPI 生成图片
...
def main():
    ...
    result = generate_image(
        prompt=args.prompt, output_dir=args.output, filename=args.filename
    )
